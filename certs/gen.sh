...
openssl req -newkey rsa:4096 -nodes -keyout server-key.pem -out server-req.pem -subj "/C=EG/ST=Egypt /L=Alexandria/O=fingo server/OU=Development/CN=localhost/emailAddress=escalopa.prod@gmail.com"
...
#openssl req -newkey rsa:4096 -nodes -keyout client-key.pem -out client-req.pem -subj "/C=EG/ST=Egypt/L=Alexandria/O=fingo client/OU=Development/CN=*.fingo.com/emailAddress=escalopa.prod@gmail.com"
